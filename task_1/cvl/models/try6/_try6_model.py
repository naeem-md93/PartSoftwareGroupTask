...
class Try6Model(nn.Module):
    def __init__(self):
        super(Try6Model, self).__init__()
        ...
        self.block4_ch_attn = ChannelAttention(16, 16, 4)
        self.block4_sp_attn = SpatialAttention(16, 16, 16, 4, 4)
        # ===================================
        ...
        self.block5_ch_attn = ChannelAttention(32, 32, 4)
        self.block5_sp_attn = SpatialAttention(32, 8, 32, 2, 4)
        ...
        self.block6_ch_attn = ChannelAttention(32, 32, 4)
        self.block6_sp_attn = SpatialAttention(32, 8, 32, 2, 4)
        ...
        self.block7_ch_attn = ChannelAttention(64, 64, 4)
        self.block7_sp_attn = SpatialAttention(64, 4, 64, 1, 4)
        ...
        # 2 x 2 ===========================
        self.block8 = ResBlock(64, 64, 128, 2)        # 2 x 2
